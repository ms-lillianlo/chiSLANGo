    ...
    <div className="card text-center">
        ...
        <h3>Phrase in Spanish: Dummy phrase</h3>
            ...
            <form action="/home" method="POST" className="answers">
                ...
                <button type="submit" className="btn btn-lg hvr-grow large" name="answer" value="{{answer2}}">Answer 1</button>
                <button type="submit" className="btn btn-lg hvr-grow large" name="answer" value="{{answer3}}">Answer 1</button>
                <button type="submit" className="btn btn-lg hvr-grow large" name="answer" value="{{answer4}}">Answer 1}</button>
            </form>
